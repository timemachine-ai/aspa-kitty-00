...
export interface Message {
  ...
  pdfData?: string; // Flag: 'attached' when PDF was sent (text not stored in state)
...
export interface ChatActions {
  handleSendMessage: (message: string, imageData?: string | string[], audioData?: string, inputImageUrls?: string[], imageDimensions?: ImageDimensions, replyTo?: ReplyToData, specialMode?: string, pdfText?: string, pdfFileName?: string) => Promise<void>;
  setChatMode: (isChatMode: boolean) => void;
}

export interface ChatInputProps {
  onSendMessage: (message: string, imageData?: string | string[], audioData?: string, inputImageUrls?: string[], imageDimensions?: ImageDimensions, replyTo?: ReplyToData, specialMode?: string, pdfText?: string, pdfFileName?: string) => Promise<void>;
  isLoading?: boolean;
}
